...
export default function Navigation() {
  ...
  return (
    <>
      ...
      <div
        className={`lg:hidden fixed top-0 left-0 right-0 bottom-0 z-[50] overflow-hidden transition-all duration-500 ease-in-out flex flex-col items-center justify-center bg-[#FAEEE9] ${menuOpen ? "opacity-100 pointer-events-auto shadow-2xl translate-y-0" : "opacity-0 pointer-events-none -translate-y-full"}`}
      >
